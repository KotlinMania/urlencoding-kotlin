...
kotlin {
    ...
    val xcf = XCFramework("Urlencoding")

    macosArm64 {
        binaries.framework { baseName = "Urlencoding"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework {
            baseName = "Urlencoding"
            isStatic = true
            xcf.add(this)
        }
    }
    ...
    iosX64 {
        // The generated iOS fat-framework tasks require every input framework
        // to be either all static or all dynamic; Swift Export needs the iOS
        // simulator bridge static, so every iOS framework matches that shape.
        binaries.framework {
            baseName = "Urlencoding"
            isStatic = true
            xcf.add(this)
    ...
    swiftExport {
        moduleName = "Urlencoding"
        flattenPackage = "io.github.kotlinmania.urlencoding"
    }

    android {
        namespace = "io.github.kotlinmania.urlencoding"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "urlencoding-kotlin", version.toString())

    pom {
        name.set("urlencoding-kotlin")
        description.set("Kotlin Multiplatform port of kornelski/rust_urlencodin - A Rust library for doing URL percentage encoding")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/urlencoding-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/urlencoding-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/urlencoding-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/urlencoding-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleUrlencodingXCFramework",
    "assembleUrlencodingDebugXCFramework",
    "assembleUrlencodingReleaseXCFramework",
    "assembleDebugIosFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseIosFatFrameworkForUrlencodingXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForUrlencodingXCFramework",
    "assembleDebugMacosFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseMacosFatFrameworkForUrlencodingXCFramework",
    "assembleDebugTvosFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseTvosFatFrameworkForUrlencodingXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForUrlencodingXCFramework",
    "assembleDebugWatchosFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseWatchosFatFrameworkForUrlencodingXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForUrlencodingXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForUrlencodingXCFramework",
