...
This file is the quick-reference operating contract for urlencoding-kotlin. The longer
...
urlencoding-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`urlencoding`](https://crates.io/crates/urlencoding). Upstream Rust is the behavioral oracle while the
